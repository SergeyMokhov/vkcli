...
//	rd := &deleteRequest{
//		VkRequestBase: NewVkRequestBase(methodBase+"delete", &DeleteResponse{}),
//	}
//
//	rd.setUserId(id)
//	return rd
...
//func (dr *deleteRequest) Perform(api api.RequestSendRetryer) (response *DeleteResponse, err error) {
